...
HappyMobiles.dataTable = { routes: {}, selected: {} };
...
export default class {
    constructor(selector, options, callback) {
        ...
        if (HappyMobiles.dataTable.selected[selector] === undefined) {
            HappyMobiles.dataTable.selected[selector] = [];
        }
    ...
    appendToSelected(id) {
        ...
        if (! HappyMobiles.dataTable.selected[this.selector].includes(id)) {
            HappyMobiles.dataTable.selected[this.selector].push(id);
        }
    }
    ...
    removeFromSelected(id) {
        ...
        HappyMobiles.dataTable.selected[this.selector].remove(id);
    }
    ...
    route(name, params) {
        let router = HappyMobiles.dataTable.routes[this.selector][name];
    ...
    hasRoute(name) {
        return HappyMobiles.dataTable.routes[this.selector][name] !== undefined;
    }

    static setRoutes(selector, routes) {
        HappyMobiles.dataTable.routes[selector] = routes;
    }

    static setSelectedIds(selector, selected) {
        HappyMobiles.dataTable.selected[selector] = selected;
    }

    static getSelectedIds(selector) {
        return HappyMobiles.dataTable.selected[selector];
    }
