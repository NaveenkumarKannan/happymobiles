...
$(function () {
    ...
    var o = $.HappyMobiles.options;

    // Set up the object
    _init();

    // Activate layout
    $.HappyMobiles.layout.activate();

    // Enable sidebar tree view controls
    if (o.enableControlTreeView) {
        $.HappyMobiles.tree('.sidebar');
    }

    // Activate sidebar push menu
    if (o.sidebarPushMenu) {
        $.HappyMobiles.pushMenu.activate(o.sidebarToggleSelector);
    }
...
/* ----------------------------------
   - Initialize the HappyMobiles Object -
   ---------------------------------- */
function _init() {
    ...
    // PushMenu
    $.HappyMobiles.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.HappyMobiles.options.screenSizes;
    ...
    // Tree
    $.HappyMobiles.tree = function (menu) {
        var animationSpeed = $.HappyMobiles.options.animationSpeed;
