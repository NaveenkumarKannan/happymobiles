...
@push('globals')
    <script>
        HappyMobiles.data['flash_sale.products'] = {!! old_json('products', $flashSale->products) !!};
        HappyMobiles.errors['flash_sale.products'] = @json($errors->get('products.*'), JSON_FORCE_OBJECT);
    </script>
@endpush
