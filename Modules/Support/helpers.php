...
if (! function_exists('is_core_module')) {
    ...
    {
        return in_array(strtolower($module), config('happymobiles.modules.core.config.core_modules'));
    }
}
...
if (! function_exists('happymobiles_version')) {
    /**
     * Get the happymobiles version.
     *
     * @return string
     */
    function happymobiles_version()
    {
        return HappyMobiles::VERSION;
    }
}
