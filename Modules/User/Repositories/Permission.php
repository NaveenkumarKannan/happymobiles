...
class Permission
{
    ...
    private static function getEnabledModulePermissions()
    {
        ...
        foreach (Module::allEnabled() as $module) {
            $config = config('happymobiles.modules.' . strtolower($module->getName()) . '.permissions');
    ...
    {
        $permissions = config('happymobiles.themes.' . strtolower(setting('active_theme')) . '.permissions');
