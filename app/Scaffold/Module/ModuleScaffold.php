...
namespace HappyMobiles\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use HappyMobiles\Scaffold\Module\Generators\FilesGenerator;
use HappyMobiles\Scaffold\Module\Generators\EntityGenerator;
...
class ModuleScaffold
{
     ...
     *
     * @var \HappyMobiles\Scaffold\Module\Generators\EntityGenerator
     */
     ...
     *
     * @var \HappyMobiles\Scaffold\Module\Generators\FilesGenerator
     */
     ...
     * @param \HappyMobiles\Scaffold\Module\Generators\EntityGenerator $entityGenerator
     * @param \HappyMobiles\Scaffold\Module\Generators\FilesGenerator $filesGenerator
     */
...
JSON;
        ...
        $replace = <<<JSON
"description": "The HappyMobiles {$moduleName} Module.",
JSON;
...
JSON;
    ...
    private function addDataToComposerJsonFile()
    {
        ...
        foreach (explode(PHP_EOL, $composerJson) as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The HappyMobiles {$moduleName} Module.\"," . PHP_EOL;
